...
var Todos = /** @class */ (function (_super) {
    ...
    Todos.prototype.toggleTodo = function (todoId) {
        this.setState({
            todos: this.state.todos.map(function (todo) {
                return __assign({}, todo, { status: todoId == todo.id ? (!todo.status) : todo.status });
            })
        });
    };
    Todos.prototype.deleteTodo = function (todoId) {
        this.setState({
            todos: this.state.todos.filter(function (todo) { return todoId != todo.id; })
        });
    };
    Todos.prototype.todoFormat = function (todo) {
        var _this = this;
        return React.createElement("div", { className: "todo " + todo.status, key: todo.id },
            React.createElement("div", { className: "text" }, todo.text),
            React.createElement("button", { className: "toggle", onClick: function () {
                    _this.toggleTodo(todo.id);
                } }, "Toggle"),
            React.createElement("button", { className: "delete", onClick: function () {
                    _this.deleteTodo(todo.id);
                } }, "X"));
    };
    Todos.prototype.displayTodos = function () {
        var _this = this;
        return React.createElement("div", { className: "displayTodos" },
            " ",
            this.state.todos.map(function (todo) {
                switch (_this.state.display) {
                    case "active":
                        if (todo.status)
                            return _this.todoFormat(todo);
                        break;
                    case "complete":
                        if (!todo.status)
                            return _this.todoFormat(todo);
    ...
    Todos.prototype.render = function () {
        ...
        return React.createElement("div", { className: "todos" },
            React.createElement("div", { className: "header" }, "Todos"),
            React.createElement("div", { className: "select" },
                React.createElement("button", { className: "all", onClick: function () {
                        _this.setState({
                            display: "all"
                        });
                    } }, "All"),
                React.createElement("button", { className: "active", onClick: function () {
                        _this.setState({
                            display: "active"
                        });
                    } }, "Active"),
                React.createElement("button", { className: "complete", onClick: function () {
                        _this.setState({
                            display: "complete"
                        });
                    } }, "Complete")),
            React.createElement("div", { className: "body" },
                React.createElement("input", { className: "enterTodo", type: "text", placeholder: "Enter Todo", onKeyDown: function (e) {
                        _this.addTodo(e);
                    } }),
                this.displayTodos()));
    };
...
ReactDOM.render(React.createElement(Todos, null), document.getElementById("app"));
